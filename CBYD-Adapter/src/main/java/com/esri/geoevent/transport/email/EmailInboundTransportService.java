...
public class EmailInboundTransportService extends TransportServiceBase
{
  public EmailInboundTransportService()
  {
    definition = new XmlTransportDefinition(getResourceAsStream("email-inbound-transport-definition.xml"));
  }
  
  public Transport createTransport() throws ComponentException
  {
    return new EmailInboundTransport(definition);
  }
}