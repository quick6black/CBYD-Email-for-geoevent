...
public class EmailOutboundTransportService extends TransportServiceBase
{
  public EmailOutboundTransportService()
  {
    definition = new XmlTransportDefinition(getResourceAsStream("email-outbound-transport-definition.xml"));
  }

  public Transport createTransport() throws ComponentException
  {
    return new EmailOutboundTransport(definition);
  }
}